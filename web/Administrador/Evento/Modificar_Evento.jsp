    ...
    <div id="padre">
        ...
        <%
                ...
                for (int i = 0; i < dat.size() ; i++) {
                        cgsc=dat.get(i);
                %>
                    <form action='../../ServletModificarEvento' method='Post' enctype='multipart/form-data'>
                    <p>Foto</p><label class='botonModi'>
                    <p><img src='../../Uploads/FotosEventos/<%=cgsc.getFoto()%>' style='width:150px;height:150px;border-radius: 150px;' id='fotomod'>
                    <input type='file' class='file' name='fo' accept='image/jpeg,image/png'></p>
                    <img src='Imagenes/Icono.png' width='40' heigth='40'></label>
                    <input type='hidden' name='fotosi' value='<%=cgsc.getFoto()%>'>   
